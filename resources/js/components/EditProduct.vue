...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            this.product.product_variant_prices.forEach(item => {
                this.product_variant_prices.push({
            ...
            this.variants.forEach(item => {
                if(Array.isArray(this.product.ProductVariantList[item.id]) && this.product.ProductVariantList[item.id].length >0){
                    this.product_variant.push({
                        option: item.id,
                        tags: this.product.ProductVariantList[item.id]
                    })
                }
